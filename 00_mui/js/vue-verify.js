...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.install = function (Vue, options) {
	    ...
	    Vue.prototype.$verify = function (rules,isdirty) {
	        var vm = this
	        ...
	        Vue.set(verifyObj, "$dirty", isdirty)
	        ...
	        function verify(modelPath, val) {
	            ...
	            if (!ruleMap.required && !methods.required.fn(val) && ruleMap.ignoreBlank!==false) {
	        ...
	        function stepVerify(modelPath, ruleMap, keys, index, val) {
	            ...
	            if (methods.hasOwnProperty(rule)) {
	            	...
	            	result = verifyFn.call(vm, val, arg)
	            }
	    ...
	    Vue.prototype.$verifyReset = function (isdirty) {
	    	var vm = this
	        var verify = this[namespace]

	        var rules = verify.$rules
	        if (rules) {
	            vm.$verify(rules,isdirty)
	        }
	    }
