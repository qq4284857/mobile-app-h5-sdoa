(function($, window) {
	...
	var template = '<div style="z-index:99999;" id="{{id}}" class="mui-slider mui-preview-image mui-fullscreen"><div class="mui-preview-header">{{header}}</div><div class="mui-slider-group"></div><div class="mui-preview-footer mui-hidden">{{footer}}</div><div class="mui-preview-loading"><span class="mui-spinner mui-spinner-white"></span></div></div>';
	...
	proto.initEvent = function() {
		var self = this;
		$(document.body).on('tap', 'img[data-preview-src]:not(.not-preview-auto)', function() {
			self.open(this);
			return false;
		});
		var laterClose = null;
